"""
Django settings for Gestion_de_las_CCAA project.
...
ROOT_URLCONF = 'Gestion_de_las_CCAA.urls'
...
WSGI_APPLICATION = 'Gestion_de_las_CCAA.wsgi.application'
